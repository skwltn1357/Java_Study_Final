...
public class A04_VarNaming {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	2. 값에 의미를 부여할 수 있다
		 	- 변수의 이름을 통해 변수의 용도를 쉽고 빠르게 파악할 수 있다
		...
		System.out.println("사과의 개당 칼로리 : " + apple_calorie);
		...
		/*
		 	...
		 	(2) 두 단어 이상을 이어붙인 변수명을 사용할 때 대문자를 사용한다 (camelCase) 
		 		ex : appleCount , minsuAge , minsuMathScore (자바에서 많이 사용)
		 		
		 	(3) 변수명 첫 글자는 소문자를 사용한다
		 	
		 	(4) 클래스명 첫 글자는 대문자를 사용한다
		 	
		 	(5) 프로그램 실행 도중 값이 변하지 않을 변수(상수)는 모두 대문자를 사용한다
		 		ex : APPLE_CALORIE, PI, 
