...
import myobj.checkpassword.IllegalLength;
import myobj.checkpassword.NotSatisfiedPassword;
import myobj.checkpassword.NumericPassword;
...
public class C17_InputRightPassword {
	...
	public static void main(String[] args) {
		try {
			check_password("wltn@#NA1234564564561");
			...
			System.out.println("비밀번호에는 숫자, 특수문자, 대문자, 소문자가 포함되어야 합니다");
		}
	}
	
	public static void check_password(String password) throws IllegalLength, NumericPassword, NotSatisfiedPassword {
