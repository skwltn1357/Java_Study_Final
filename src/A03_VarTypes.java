	...
	public static void main(String[] args) {
		/*
		 ...
		 - byte (1byte) -128 ~ +127
		 	...
		 	부호를 사용하는 경우에는 첫 번쨰 bit를 부호 비트로 사용한다
		 ...
		 - char (2byte unsigned 부호없음) 0 ~ 65535 ※문자 코드 저장용
		...
		// int 타입의 범위를 벗어나는 값을 사용하고 싶다면 뒤에 l 또는 L을 붙여야 한다
