...
public class S01_JavaSwing {
	/*
	 	...
	 	# Component
	 	 ...
	 	 - 컨테이너 위에 배치할 수 있는 부품 (버튼,표,슬라이더,메뉴 ...)
	 */
	...
	public static void main(String[] args) {
		...
		// X버튼 눌렀을 때의 동작을 설정
		frame.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE); //안꺼짐
		frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);	//잠깐 꺼짐
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);	//아예 꺼짐
		// 프레임 크기 설정
		frame.setSize(500, 500);
		// 설정된대로 프레임을 보이게 한다. (화면에 그리는 효과가 있다) - 맨 마지막에 두는게 좋음.
