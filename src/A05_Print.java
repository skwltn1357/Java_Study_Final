...
public class A05_Print {
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	# 서식 문자의 종류
		 	%d : 해당 자리에 전달한 정수값을 10진수로 출력해준다 (decimal) 10진수
		 	%x, %X : 해당 자리에 전달한 정수값을 16진수로 출력해준다 (hexa decimal) 16진수
		 	%o : 해당 자리에 전달한 정수값을 8진수로 출력해준다 (octal) 8진수
		 	%s : 문자열
		 	%c : 문자
		 	%f : 실수
		 	
		 	# 10진수 (10개의 숫자를 가지고 만듦)
		...
		System.out.printf("%d를 10진수로 출력하면 %d 입니다.\n",year,year);
		System.out.printf("%d를 8진수로 출력하면 %o 입니다.\n",year,year);
		System.out.printf("%d를 16진수로 출력하면 %x 입니다.\n",year,year);
		System.out.printf("%d를 16진수로 출력하면 %X 입니다.\n",year,year);
