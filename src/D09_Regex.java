 ...
 */
	...
	public static void main(String[] args) {
		...
		System.out.println(Pattern.matches("010-[\\d]{4}-[\\d]{4}", "010-1234-1234"));	//지수풀이
		System.out.println(Pattern.matches("010-?\\d{4}-?\\d{4}","010-1234-1234"));	//선생님 풀이
		System.out.println(Pattern.matches("010(-?\\d{4}){2}","01012341234"));	//선생님 풀이
		System.out.println(Pattern.matches("010-?[1-9]\\d{3}-?\\d{4}","01012341234"));	//선생님 풀이
