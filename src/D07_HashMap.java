...
public class D07_HashMap {
	...
	/*
	 	# Map
	 	 ...
	 	 - 데이터를 Kew와  Value를 한 쌍으로 저장하는 방식의 자료구조 
	 	 - Key 값을 통해 Value에 접근할 수 있다
	 	 - Key는 중복을 허용하지 않는다
	 */
	
	public static void main(String[] args) {
		// 첫 번째 제너릭은 key의 타입이고, 두 번째 제네릭은 Value의 타입이다
		...
		// - 해당 키값이 비어있으면 넣고, 뭔가 있으면 꺼내준다. 넣은 경우 null을 리턴한다
		addr.put("우리집","서울특별시 동작구 노량진1동 ...");
		addr.put("직장","서울특별시 강남구 강남대로 84길 16");
		...
		/*
		 	# 반복문으로 Map타입 활용하기
		 	 ...
		 	 - Map.entrySet() : Extry<key, value>로 이루어진 Set을 반환한다
		 */
